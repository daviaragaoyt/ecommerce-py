...
app=Flask(__name__)
app.config['SECRET_KEY']="ssp_api_123"
app.config['SQLALCHEMY_DATABASE_URI']='sqlite:///ecommerce.db'

#Definir uma rota raiz (pagina inicial) e função que sera executada ao requisitar
...
def add_produto():
   ...
   return jsonify({'message':'Produto com dados invalidos!'}),400
